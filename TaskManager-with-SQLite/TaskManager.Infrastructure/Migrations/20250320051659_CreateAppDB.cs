    ...
    public partial class CreateAppDB : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "TEXT", nullable: false),
                    Content = table.Column<string>(type: "TEXT", maxLength: 75, nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "FirstName", "LatName", "PasswordHash", "Username" },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "23bf9c00-056c-4c72-9fa7-396c28da66c7", "669fe84c-19ce-41f9-ba64-2c844d2b851b", new DateTime(2025, 3, 20, 7, 16, 59, 577, DateTimeKind.Local).AddTicks(7937), null, "Create final project for the WPF course.", null, false, false, null, "0a7bead2-d075-4100-b803-05498f07347b", "90b21bc9-9062-4142-b3f9-774e6797e080" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "6eb3a493-8160-475f-a4f3-62089765c162", "Use separate projects for database, business logic and WPF application.", new DateTime(2025, 3, 20, 7, 16, 59, 577, DateTimeKind.Local).AddTicks(7877), null, null, false, false, null, "23bf9c00-056c-4c72-9fa7-396c28da66c7" },
                    { "971138d8-d689-4820-8f23-535d1bac1ade", "Create application database with at least 5 database models.", new DateTime(2025, 3, 20, 7, 16, 59, 577, DateTimeKind.Local).AddTicks(7836), null, null, false, false, null, "23bf9c00-056c-4c72-9fa7-396c28da66c7" }
                });
